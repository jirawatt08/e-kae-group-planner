  ...
  return (
    <div className="bg-card border border-border rounded-lg p-4 shadow-sm transition-colors">
      ...
      {extraDetails.length > 0 && (
        <div className="mb-3 bg-warning/10 border border-warning/20 rounded-md p-2">
          <p className="text-[10px] font-black text-warning uppercase tracking-widest mb-1">{t('extra_costs') || 'Extra Costs'}</p>
            ...
            return (
              <div key={uid} className="flex items-center justify-between text-sm">
                ...
                <div className="flex items-center space-x-2">
                  <span className={`text-xs font-bold leading-none ${hasPaid ? 'text-success' : 'text-warning'}`}>
