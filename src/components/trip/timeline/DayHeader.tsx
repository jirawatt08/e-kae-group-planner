...
export function DayHeader({ dayKey, dayNumber, eventCount }: DayHeaderProps) {
  ...
  return (
    <div className="sticky top-0 z-10 bg-muted/80 backdrop-blur-sm -mx-4 px-4 py-2 mb-4 border-y border-border flex items-center justify-between">
      ...
      <div className="flex items-center text-[10px] text-muted-foreground font-medium bg-card px-2 py-0.5 rounded-full border border-border shadow-xs">
